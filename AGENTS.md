...
| `data/watersheds/west-huc6.geojson` | The 75 default drainage areas the maps draw and the western roster is assigned against. Committed for reproducible analysis; never copied to `dist/`. |
| `huc6.geojson` | The fourteen-area Utah-connected historical scope, retained for compatibility and parity checks. |
